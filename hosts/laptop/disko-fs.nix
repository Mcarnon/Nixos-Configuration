# Partitioning as code (disko): tmpfs root + plain btrfs subvolumes.
...
# ROOT / ESP UUIDs into ./hardware-configuration.nix.
#
          ...
          root = {
            ...
            content = {
              ...
              subvolumes = {
                ...
                # Swap as a swapfile inside the btrfs subvolume.
                "@swap" = {
                  mountpoint = "/swap";
