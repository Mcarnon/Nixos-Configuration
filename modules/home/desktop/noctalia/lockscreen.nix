...
{ config, lib, ... }:
{
  programs.noctalia.settings = {
    ...
    shell.session.actions = [
      { action = "lock"; countdown_seconds = 0; enabled = true; variant = "default"; }
      { action = "lock_and_suspend"; countdown_seconds = 5; enabled = true; variant = "default"; }
      { action = "logout"; countdown_seconds = 0; enabled = true; variant = "default"; }
      { action = "reboot"; countdown_seconds = 5; enabled = true; variant = "default"; }
      { action = "shutdown"; countdown_seconds = 5; enabled = true; variant = "destructive"; }
    ];
