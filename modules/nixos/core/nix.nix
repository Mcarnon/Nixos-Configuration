...
{ config, pkgs, lib, ... }:
{
  ...
  programs.nh = {
    enable = true;
    # Where this flake lives on the machine (matches README's ~/Nixos-Configuration).
    flake = "/home/mccarnon/Nixos-Configuration"; # TODO: adjust to your local checkout path
